...
namespace SlvHanbai.Web.WebService
{
    ...
    {
        private const string CLASS_NM = "svcCustomer";
        private readonly string PG_NM = DataPgEvidence.PGName.Mst.Customer;
        ...
        public EntityCustomer GetCustomer(string random, string Id)
        {
            ...
            catch (Exception ex)
            {
                ...
                entity = new EntityCustomer();
                entity.MESSAGE = CLASS_NM + ".GetCustomer : 認証処理に失敗しました。" + Environment.NewLine + ex.Message.ToString(); ;
                return entity;
            }
            ...
            try
            {
                ...
                sb.Append("      ,CM.NAME AS INVOICE_NAME " + Environment.NewLine);
                ...
                sb.Append("      ,NM6.DESCRIPTION AS COLLECT_CYCLE_NAME " + Environment.NewLine);
                ...
                sb.Append("   AND CL1.CLASS_DIVISION_ID = " + (int)CommonUtl.geMGroupKbn.CustomerGrouop1 + Environment.NewLine);
                ...
                sb.Append("   AND CL2.CLASS_DIVISION_ID = " + (int)CommonUtl.geMGroupKbn.CustomerGrouop2 + Environment.NewLine);
                ...
                sb.Append("   AND CL3.CLASS_DIVISION_ID = " + (int)CommonUtl.geMGroupKbn.CustomerGrouop3 + Environment.NewLine);
                ...
                if (dt.DefaultView.Count > 0)
                {
                    ...
                    if (strErr != "")
                    {
                        entity.MESSAGE = CLASS_NM + ".GetCustomer : 排他制御(ロック情報取得)に失敗しました。" + Environment.NewLine + strErr;
                    }
                    ...
                    entity.collect_cycle_nm = ExCast.zCStr(dt.DefaultView[0]["COLLECT_CYCLE_NAME"]);
            ...
            catch (Exception ex)
            {
                ...
                entity = new EntityCustomer();
                entity.MESSAGE = CLASS_NM + ".GetCustomer : 予期せぬエラーが発生しました。" + Environment.NewLine + ex.Message.ToString();
            }
            finally
            {
                db = null;
