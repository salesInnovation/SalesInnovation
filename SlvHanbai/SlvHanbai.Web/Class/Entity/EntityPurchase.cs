...
{
    [DataContract]
    public class EntityPurchase : EntityBase
    {
        ...
        [DataMember()]
        private long purchase_order_no = 0;
        ...
        { 
            ...
            get { return this.purchase_order_no; } 
        }

        [DataMember()]
        private string purchase_ymd;
        public string PURCHASE_YMD 
        { 
            set 
            {
                this.purchase_ymd = value;
                base.PropertyChangedHandler(this, "PURCHASE_YMD");
            }
            get { return this.purchase_ymd; } 
        }
