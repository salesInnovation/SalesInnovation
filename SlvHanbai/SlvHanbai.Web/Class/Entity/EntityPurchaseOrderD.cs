...
{
    [DataContract]
    public class EntityPurchaseOrderD : EntityBase
    {
        ...
        [DataMember()]
        private double _purchase_cost;
        public double purchase_cost
        {
            set
            {
                this._purchase_cost = value;
                base.PropertyChangedHandler(this, "purchase_cost");
            }
            get { return this._purchase_cost; }
        }
