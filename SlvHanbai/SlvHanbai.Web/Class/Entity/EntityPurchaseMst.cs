...
{
    [DataContract]
    public class EntityPurchaseMst : EntityBase
    {
        ...
        public double payment_credit_price
        {
            ...
            get
            {
                return this._payment_credit_price;
            }
        }
        ...
        public string payment_division_id
        {
            ...
            get
            {
                return this._payment_division_id;
            }
        }
        ...
        public string payment_division_nm
        {
            ...
            get
            {
                return this._payment_division_nm;
            }
        }
        ...
        [DataMember()]
        private string _payment_cycle_nm = "";
        public string payment_cycle_nm
        {
            set
            {
                this._payment_cycle_nm = value;
                base.PropertyChangedHandler(this, "payment_cycle_nm");
            }
            get
            {
                return this._payment_cycle_nm;
            }
        }
