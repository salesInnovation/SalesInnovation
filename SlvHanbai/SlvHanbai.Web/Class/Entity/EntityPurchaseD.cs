...
{
    [DataContract]
    public class EntityPurchaseD : EntityBase
    {
        ...
        // 発注ID
        [DataMember()]
        private double _purchase_order_id;
        public double purchase_order_id
        {
            set
            {
                this._purchase_order_id = value;
                base.PropertyChangedHandler(this, "purchase_order_id");
            }
            get { return this._purchase_order_id; }
        }

        // 発注数
        [DataMember()]
        private double _purchase_order_number;
        public double purchase_order_number
        {
            set
            {
                this._purchase_order_number = value;
                base.PropertyChangedHandler(this, "purchase_order_number");
            }
            get { return this._purchase_order_number; }
        }


        // 発注残数
        [DataMember()]
        private double _purchase_order_stay_number;
        public double purchase_order_stay_number
        {
            set
            {
                this._purchase_order_stay_number = value;
                base.PropertyChangedHandler(this, "purchase_order_stay_number");
            }
            get { return this._purchase_order_stay_number; }
        }
