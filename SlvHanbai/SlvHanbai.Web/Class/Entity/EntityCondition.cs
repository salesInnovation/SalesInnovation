...
{
    [DataContract]
    public class EntityCondition : EntityBase
    {
        ...
        [DataMember()]
        private int _condition_divition_id = 0;
        public int condition_divition_id
        {
            set
            {
                this._condition_divition_id = value;
                base.PropertyChangedHandler(this, "condition_divition_id");
            }
            get
            {
                return this._condition_divition_id;
            }
        }
