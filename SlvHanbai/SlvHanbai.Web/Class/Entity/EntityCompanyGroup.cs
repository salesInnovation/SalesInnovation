...
{
    [DataContract]
    public class EntityCompanyGroup : EntityBase
    {
        ...
        [DataMember()]
        private int _estimate_approval_flg = 1;
        public int estimate_approval_flg
        {
            set
            {
                this._estimate_approval_flg = value;
                base.PropertyChangedHandler(this, "estimate_approval_flg");
            }
            get
            {
                return this._estimate_approval_flg;
            }
        }
        ...
        public string bank_nm
        {
            ...
            {
                this._bank_nm = value;
                base.PropertyChangedHandler(this, "bank_nm");
            }
            get
            {
                return this._bank_nm;
            }
        }

        [DataMember()]
        private string _bank_branch_nm = "";
        public string bank_branch_nm
        {
            set
            {
                this._bank_branch_nm = value;
                base.PropertyChangedHandler(this, "bank_branch_nm");
            }
            get
            {
                return this._bank_branch_nm;
            }
        }
        ...
        public string bank_account_no
        {
            set
            {
                ...
                base.PropertyChangedHandler(this, "bank_account_no");
            }
            get
            {
        ...
        [DataMember()]
        private string _bank_account_nm = "";
        public string bank_account_nm
        {
            set
            {
                this._bank_account_nm = value;
                base.PropertyChangedHandler(this, "bank_account_nm");
            }
            get
            {
                return this._bank_account_nm;
            }
        }

        [DataMember()]
        private string _bank_account_kana = "";
        public string bank_account_kana
        {
            set
            {
                this._bank_account_kana = value;
                base.PropertyChangedHandler(this, "bank_account_kana");
            }
            get
            {
                return this._bank_account_kana;
            }
        }
