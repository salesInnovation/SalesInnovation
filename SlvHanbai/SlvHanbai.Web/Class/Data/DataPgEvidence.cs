...
namespace SlvHanbai.Web.Class.Data
{
    public class DataPgEvidence
    {
        ...
        public class PGName
        {
            ...
            {
                public const string BusinessInp = "BusinessInp";            // 業務連絡登録
                public const string BusinessList = "BusinessList";           // 業務連絡参照
            }
            ...
            public class PurchaseOrder
            {
                ...
                public const string PurchaseOrderPrint = "PurchaseOrderPrint";              // 発文請書印刷
            ...
            public class Mst
            {
                ...
                public const string SetCommodity = "SetCommodityMst";           // セット商品マスタ
        ...
        public static string GetPgName(string pgId)
        {
            switch (pgId)
            {
                ...
                case DataPgEvidence.PGName.Order.OrderList:
                    return "受注一覧";
                case DataPgEvidence.PGName.Order.OrderListPrint:
                    return "受注一覧印刷";
